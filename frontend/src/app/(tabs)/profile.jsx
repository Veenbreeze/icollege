...
export default function ProfileScreen() {
  ...
  const stats = [
    {
      value: String(user.successScore),
      label: 'Success Score',
      color: colors.primary,
    },
    {
      value: portfolio ? (portfolio.stats.find((s) => s.label === 'Projects')?.value ?? '0') : '0',
      label: 'Projects',
      color: colors.orange,
    },
    {
      value: portfolio ? (portfolio.stats.find((s) => s.label === 'Certifications')?.value ?? '0') : '0',
      ...
      >
        ...
        <View style={styles.identity}>
          <Pressable onPress={() => router.push('/edit-profile')} style={styles.avatarWrap}>
            <Avatar initials={initialsOf(user.fullName)} uri={resolveMediaUrl(user.avatarUrl)} size={84} ring />
        ...
        <View style={styles.appearance}>
          {APPEARANCE.map((opt) => {
            ...
            return (
              ...
              >
                <Ionicons name={opt.icon} size={20} color={active ? colors.white : colors.textSecondary} />
                <Text
                  style={[
        ...
        <Card style={styles.menuCard}>
          {MENU.map((m, i) => (
            <Pressable
              ...
              onPress={() => 'route' in m && m.route && router.push(m.route)}
            >
