      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: spacing.lg }}>
        ...
        <View style={styles.hero}>
          <View style={[styles.logo, { backgroundColor: opp.soft }]}>
            <Text style={{ fontSize: 34 }}>{opp.logo}</Text>
          </View>
          ...
          <View style={[styles.matchBanner, { backgroundColor: colors.greenSoft }]}>
            <Ionicons name="sparkles" size={14} color={colors.green} />
            <Text style={styles.matchText}>{opp.matched}% match with your profile</Text>
          </View>
        </View>
        ...
        <Card style={[styles.metaCard, { marginTop: spacing.sm }]}>
          <MetaCell icon="cash-outline" label="Compensation" value={opp.pay} />
          <View style={styles.vDiv} />
          <MetaCell icon="calendar-outline" label="Deadline" value={opp.deadline} />
        </Card>
...
function Bullet({ text, icon, color }: { text: string; icon?: any; color: string }) {
  return (
...
const styles = themedStyles((colors) => ({
  ...
  logo: { width: 72, height: 72, borderRadius: radii.xl, alignItems: 'center', justifyContent: 'center', marginBottom: spacing.md },
  role: { fontSize: 21, fontWeight: '800', color: colors.text, textAlign: 'center' },
  companyRow: { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 4 },
  company: { fontSize: 15, color: colors.textSecondary },
  matchBanner: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: spacing.lg, paddingVertical: spacing.sm, borderRadius: radii.pill, marginTop: spacing.md },
  matchText: { fontSize: 13, fontWeight: '700', color: colors.green },

  metaCard: { flexDirection: 'row', alignItems: 'center', marginHorizontal: spacing.lg, marginTop: spacing.lg },
  metaCell: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
  metaIcon: { width: 36, height: 36, borderRadius: radii.sm, backgroundColor: colors.primarySoft, alignItems: 'center', justifyContent: 'center' },
  metaLabel: { fontSize: 11, color: colors.textMuted },
  metaValue: { fontSize: 13.5, fontWeight: '700', color: colors.text },
  vDiv: { width: 1, height: 34, backgroundColor: colors.border, marginHorizontal: spacing.md },
  ...
  tag: { backgroundColor: colors.primarySoft, paddingHorizontal: spacing.md, paddingVertical: 6, borderRadius: radii.sm },
  tagText: { fontSize: 12.5, color: colors.primary, fontWeight: '600' },

  bullet: { flexDirection: 'row', gap: spacing.sm, marginBottom: spacing.sm, alignItems: 'flex-start' },
  ...
  applyBar: {
    ...
    paddingTop: spacing.md, paddingBottom: spacing.sm, backgroundColor: colors.surface,
    borderTopWidth: 1, borderTopColor: colors.border,
  },
  saveBtn: { width: 52, height: 52, borderRadius: radii.md, borderWidth: 1.5, borderColor: colors.border, alignItems: 'center', justifyContent: 'center' },
  applyBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, height: 52, borderRadius: radii.md, backgroundColor: colors.primary },
