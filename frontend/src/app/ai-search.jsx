...
import { searchAll } from '@/lib/api/ai';
import { resolveAccent } from '@/lib/colorKey';
import { searchExamples } from '@/data/mock';
          ...
          <>
            <View style={styles.hero}>
              ...
              <Text style={styles.heroSub}>
                Search across notices, documents, clubs, events, opportunities and projects. Just describe what you
                need.
              </Text>
            </View>
          ...
          <>
            ...
            {!loading && (
              <>
                ...
                {results.map((r) => {
                  const { color, soft } = resolveAccent(r.colorKey);
                  return (
                    <Pressable key={r.id} onPress={() => r.route && router.push(r.route)}>
                      <Card style={styles.resultCard}>
                        ...
                        >
                          <Ionicons name={r.icon} size={20} color={color} />
                        </View>
                        <View
                          style={{
                            flex: 1,
